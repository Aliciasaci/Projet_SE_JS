...
import type { AddUpdateCallback, AllPerformanceEntry, EventBuffer, InstrumentationTypeBreadcrumb, InternalEventContext, PopEventContext, RecordingEvent, RecordingOptions, ReplayContainer as ReplayContainerInterface, ReplayPluginOptions, ReplayRecordingMode, SendReplay, Session } from './types';
export declare class ReplayContainer implements ReplayContainerInterface {
     ...
     */
    sendReplayRequest({ events, replayId, segmentId: segment_id, includeReplayStartTimestamp, eventContext, }: SendReplay): Promise<void | undefined>;
    resetRetries(): void;
    /**
