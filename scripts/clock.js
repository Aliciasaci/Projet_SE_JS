export function renderClock() {
    ...
    <div id="clock" class="wrapper">
        <div class="card">
            <div class="tab">
                <button class="tab-links" onclick="openTab(event, 'tab-clock')" id="default-tab">Horloge</button>
                <button class="tab-links" onclick="openTab(event, 'tab-stop-watch')">Chronomètre</button>
                <button class="tab-links" onclick="openTab(event, 'tab-timer')">Minuteur</button>  
            </div>
            ...
            <div id="tab-stop-watch" class="tab-content">
                <div>
                    <span id="min">00</span> :
                    <span id="sec">00</span> ,
